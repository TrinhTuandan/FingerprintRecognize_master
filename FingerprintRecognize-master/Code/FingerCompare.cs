...
namespace FingerprintRegnition
{
	...
	public class FingerCompare : System.Windows.Forms.Form
	{
        ...
        private StatusBarPanel statueP2;
		...
		private void InitializeComponent()
		{
            ...
            this.pic2.Location = new System.Drawing.Point(346, 92);
            this.pic2.Name = "pic2";
            ...
            this.pic1.Location = new System.Drawing.Point(19, 92);
            this.pic1.Name = "pic1";
            ...
            this.toolBar1.Size = new System.Drawing.Size(654, 33);
            ...
            this.statusBar1.Size = new System.Drawing.Size(654, 26);
		...
		private void toolBar1_ButtonClick(object sender, System.Windows.Forms.ToolBarButtonClickEventArgs e)
		{
			...
			{
				menuItem2_Click(sender,e); // Mở Ảnh 1 
			}
			if(e.Button == bt2OpenPic)
			{
				menuItem3_Click(sender,e); // Mở Ảnh 2
            }
			if(e.Button == btCompare)
			{
				menuItem6_Click(sender,e);// só Sánh Vân Tay
			}
			if(e.Button == btViewMinu)
			{
				menuItem8_Click(sender,e);// Hiển Thị Chi Tiết
			}
			if(e.Button == btViewCpDetail)
			{
				menuItem7_Click(sender,e);// Thông Tin So Sánh
			}
			if(e.Button == btAbout)
			{
				menuItem13_Click(sender,e);// Hiện thị thông tin tác giả
			}
		}
